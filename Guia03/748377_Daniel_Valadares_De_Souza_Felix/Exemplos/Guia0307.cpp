...
void decorateWorld(const char *fileName)
{
    ...
    // world->set(4, 4, VWALL); // paredes removidas para realizacao de teste
    // world->set(4, 4, HWALL); // paredes removidas para realizacao de teste
...
ERROR: Can't move. // Erro dado por conta do robo virar para o lado errado, cocertado 
---------------------------------------------- previsao de testes
---------------------------------------------- historico
