 ...
 */
    ...
    int pickBeepers()
    {
        ...
        int y = 0;
        char msg [80];
        std::fstream arquivo ("Tarefa0313b.txt",std::ios::app);
        ...
        arquivo << n << std::endl; // salvar numero de beepers coletados
        arquivo << x << std::endl; // salvar cordenada x da coleta
        arquivo << y << std::endl; // salvar cordenada y da coleta
