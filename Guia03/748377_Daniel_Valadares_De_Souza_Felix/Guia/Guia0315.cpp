 ...
 */
    ...
    void halfPathRight() // metade do caminho da direita
    {
        while (!facingWest)
        {
            turnLeft();
        }
        while (areYouHere (5,5)||areYouHere (5,6))
        {
            move();
        }
    }   // end void halfPathRight()
    void halfPathLeft() // metade do caminho da direita
    {
        while (!facingEast)
        {
            turnLeft();
    ...
    int pickBeepers()
    {
        ...
        int y = 0;
        char msg [80];
        std::fstream arquivo ("Tarefa0315b.txt",std::ios::app);
        ...
        arquivo << x,            // salvar cordenada x
        arquivo << y << std::endl; // salvar cordenada y
        arquivo << n << std::endl; // salvar cordenada y
        // end while
...
*/
    int main()
    {
        ...
        robot1->create ( 8, 5, WEST, 0, "Jarel" ); // 'K'
        robot2->create ( 2, 5, EAST, 0, "Karel" ); // 'J'
...
Versao Teste
 ...
 0.13   01. ( OK ) teste de recordacao de cordenadas por numero de coleta de beepers 
 0.14   01. (    ) teste de recordacao de trajeto
 0.15   01. (    ) teste de multiplos robos
 */