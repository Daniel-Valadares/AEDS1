...
/**
 method0414 - Contar e mostrar as letras maisculas maiores que K em uma cadeia de caracteres
*/
void method0414()
{
    // definir dados
    ...
    // identificar
    IO_id("Exemplo0414 - method0414 - v0.0");
...
int main()
{
    ...
    do
    {
        ...
        IO_println("Opcoes");
        IO_println(" 0 - parar");
        IO_println(" 1 - Contar e mostrar as letras maisculas maiores que K em uma cadeia de caracteres");
        IO_println("");
