...
/**
 method0415 - Contar e mostrar o numero de letras maiores que K (minuscula e maiuscula) em uma cadeia de caracteres
*/
void method0415()
{
    // definir dados
    ...
    // identificar
    IO_id("Exemplo0415 - method0415 - v0.0");
...
int main()
{
    ...
    do
    {
        ...
        IO_println("Opcoes");
        IO_println(" 0 - parar");
        IO_println(" 1 - Contar e mostrar o numero de letras maiores que K (minuscula e maiuscula) em uma cadeia de caracteres");
        IO_println("");
...
Versao Teste
 ...
 0.15 01. ( OK ) Contar e mostrar o numero de letras maiores que K (minuscula e maiuscula) em uma cadeia de caracteres
 */