...
/**
 method0419 - Contar e mostrar a quantidade de simbolos nao alfanumericos em uma cadeia de caracteres
*/
void method0419()
{
    // definir dados
    ...
    // identificar
    IO_id("Exemplo0419 - method0419 - v0.0");
    ...
    // contar alfanumerico
    resultado = countAlphanumeric(palavra);

    //mostrar resultados do calculo
    IO_printf("Quantidade de simbolos alfanumericos na cadeia: %d\n", resultado);
...
int main()
{
    ...
    do
    {
        ...
        IO_println("Opcoes");
        IO_println(" 0 - parar");
        IO_println(" 1 - Contar e mostrar a quantidade de simbolos alfanumericos em uma cadeia de caracteres");
        IO_println("");
