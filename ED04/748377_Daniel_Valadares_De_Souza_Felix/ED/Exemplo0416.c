...
int biggerThanLetterK(char x[])
{
    ...
    for (posicao = 0; posicao < tamanho; posicao = posicao + 1)
    {
        ...
        if (('K' < simbolo && simbolo <= 'Z') || ('k' < simbolo && simbolo <= 'z'))
        {
            // contar e mostrar quantidade contada
            contar = contar + 1;
            IO_printf("Repeticao: %d\n%d: [%c]\n\n", contar, posicao, simbolo);

            // salvar numero contado em outra cadeia
    ...
    if (contar > 0)
    {
        IO_printf("Simbolos maiores que K identificados:\n%s\n", registrar);
    }
    else
    {
        IO_printf("Nenhum simbolo maior que K identificado\n");
    }
    return (contar);
} // fim biggerThanLetterK ( )

/**
 method0416 - Contar e mostrar as letras maiores que K (minuscula e maiuscula) em uma cadeia de caracteres
*/
void method0416()
{
    // definir dados
    ...
    // identificar
    IO_id("Exemplo0416 - method0416 - v0.0");
    ...
    IO_printf("Letras maiusculas e minusculas maiores que K: %d\n", resultado);
...
int main()
{
    ...
    do
    {
        ...
        IO_println("Opcoes");
        IO_println(" 0 - parar");
        IO_println(" 1 - Contar e mostrar as letras maiores que K (minuscula e maiuscula) em uma cadeia de caracteres");
        IO_println("");
