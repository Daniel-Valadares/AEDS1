...
---------------------------------------------- previsao de testes
---------------------------------------------- historico
ERROR: No beeper. // Solucao: erro causado por falha em uma tentativa de coleta de marcado de cordenado onde não possuia um beeper, resolvido apos pequena revisao no codigo
