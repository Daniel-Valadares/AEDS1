...
void decorateWorld(const char *fileName)
{
    ...
    ;{
        ...
        for ( place = 1; place <= 1; place = place + 1 ) // repeticao ate valor 3
        {
            world->set(5, 3, BEEPER); //por beeper
            world->set(4, 5, BEEPER); //por beeper
            world->set(6, 5, BEEPER); //por beeper
            world->set(5, 7, BEEPER); //por beeper
...
int main()
{
    ...
    robot->create(2, 2, NORTH, 0, "Karel");
    // executar tarefa
    robot->doTask();
...
Robo perder sua orientacao // resolvido depois de analisar o problema e corrigir o codigo
Robo nao terminar no local inicial // resolvido depois de uma pequena adaptacao no codigo
Robo mostrava error a tentar dar shutdown // resolvido adicionando um break ao lado do turnOff
---------------------------------------------- previsao de testes
---------------------------------------------- historico
