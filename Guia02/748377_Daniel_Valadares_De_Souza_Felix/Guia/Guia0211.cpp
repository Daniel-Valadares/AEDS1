...
void decorateWorld(const char *fileName)
{
    ...
    ;{
        ...
        {
            world->set(7, 3, BEEPER); //por beeper
            if (place<3) // limitar numero de repeticoes
            {
                world->set(8, 2, BEEPER); //por beeper
            } // end if
            if (place<2) // limitar numero de repeticoes
            {
                world->set(9, 1, BEEPER); //por beeper
            } // end if
        } // end for
    } // end BEEPERS
...
Infnitos beepers sendo colocados no mundo // resolvido depois de uma pequena adaptacao no codigo
---------------------------------------------- previsao de testes
---------------------------------------------- historico
