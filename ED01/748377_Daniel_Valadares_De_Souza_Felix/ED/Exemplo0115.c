...
{
  // definir dado
  double base    = 0;  // definir variavel real da base de um triangulo
  double altura  = 0;  // definir variavel real da altura de um triangulo
  double area    = 0;  // definir variavel real da divisao area de um triangulo
                       // identificar
  printf("\n%s\n", "Exemplo0115 - Programa = v0.0");
  printf("%s\n", "Autor: 748377_Daniel_Valadares_De_Souza_Felix");

  // ler do teclado o valor inteiro
  printf("\n\n%s", "Entrar com um valor real, equivalente a base de um triangulo: ");
  scanf("%lf", &base);   // valor da base
  printf("\n%s", "Agora, com um valor real, insira um valor equivalente a altura de um triangulo: ");
  ...
  printf("\n%s%lf%s", "Um triangulo com a metade do valor de altura inserido, tem sua altura equivalente a ", 
          altura, ", e possui:");
  printf("%s%lf\n", " Uma area de ", area);
