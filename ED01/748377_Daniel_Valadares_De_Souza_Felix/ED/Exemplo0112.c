...
int main(int argc, char *argv[])
{
  ...
  int area       = 0; // definir variavel inteiro da area de um quadrado
  int perimetro  = 0; // definir variavel inteira do perimetro de um quadrado
                      // identificar
  ...
  printf("\n%s%d%s\n\n\t%s%d\n\t%s%d\n", "Um quadrado com o dobro de lado, tem seu lado equivalente a ", lado, ", e possui: ", 
         "Como area o valor de: ", area, "E como de perimetro o valor de: ",perimetro);
