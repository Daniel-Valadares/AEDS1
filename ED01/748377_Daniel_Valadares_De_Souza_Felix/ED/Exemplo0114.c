...
int main(int argc, char *argv[])
{
  ...
  int area       = 0; // definir variavel inteiro da area de um retangulo
  int perimetro  = 0; // definir variavel inteira do perimetro de um retangulo
                      // identificar
  ...
  printf("\n%s%d%s%d%s\n\n", "Um retangulo com triplo do valor de base e de altura, o qual equivale, respectivamente, a ", 
          base, " e ", altura, ", possui: ");
  printf("\t%s%d\n", "Como area o valor de: ", area);
  printf("\t%s%d\n", "E como de perimetro o valor de: ",perimetro);     
