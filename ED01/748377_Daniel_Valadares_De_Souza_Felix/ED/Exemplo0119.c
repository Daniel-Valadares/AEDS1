...
{
  // definir dado
  double raio = 0;  // definir variavel real do raio de um circulo
  double area = 0;  // definir variavel real da area de um circulo
                           // identificar
  printf("\n%s\n", "Exemplo0119 - Programa = v0.0");
  printf("%s\n", "Autor: 748377_Daniel_Valadares_De_Souza_Felix");

  // ler do teclado o valor inteiro
  printf("\n\n%s", "Entrar com um valor real, equivalente ao raio de um circulo: ");
  scanf("%lf", &raio);  // valor do raio
  ...
  printf("\n%s%lf%s\n\n", "Um circulo com um quarto do valor de raio inserido, tem o raio equivalente a ", raio, ", e possui:");
  printf("\t%s%lf", "Uma area igual a ", area);
...
0.19 __/__ teste de calculo com circulo
---------------------------------------------- testes
Versao Teste
...
0.19 01. ( OK ) teste de calculo com circulo
*/