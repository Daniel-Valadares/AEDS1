...
{
  // definir dado
  double lado      = 0;  // definir variavel real do lado de um cubo
  double volume    = 0;  // definir variavel real do volume de um cubo
                         // identificar
  printf("\n%s\n", "Exemplo0117 - Programa = v0.0");
  printf("%s\n", "Autor: 748377_Daniel_Valadares_De_Souza_Felix");

  // ler do teclado o valor inteiro
  printf("\n\n%s", "Entrar com um valor real, equivalente ao lado de um cubo: ");
  ...
  printf("\n%s%lf%s\n\n", "Um cubo com um quarto do valor do lado inserido, tem seu lado equivalente a ", 
          lado, ", e possui:");
