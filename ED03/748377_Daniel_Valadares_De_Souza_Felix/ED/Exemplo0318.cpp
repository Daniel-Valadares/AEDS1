...
void method0318()
{
    ...
    for (y = 0; y < qnt; y = y + 1)
    {
        ...
        if (menor <= test && test <= maior && test%5 == 0 && !(test%3 == 0))
        {
            // contar repeticoes
            rpt = rpt + 1;
    ...
    IO_printf("\nNumero de multiplos de 5, mas nao multiplos de 3, dentro do intervalo: %d\n", rpt);
...
int main()
{
    ...
    do
    {
        ...
        IO_println("Opcoes");
        IO_println(" 0 - parar");
        IO_println(" 1 - contar e mostrar uma quantidade de valores que forem multiplos de 5 e nao multiplos de 3, e pertencam a um intervalo fechado");
