...
// contar e mostrar digitos em uma string do fim para o inicio
void method0315()
{
    // definir dado
    int x = 0;
    ...
    for (y = tamanho; y >= 0; y = y - 1)
    {
        ...
        {
            // contar repeticoes de digitos
            z = z + 1;
            // mostrar valor atual
            IO_printf("%d: [%c]\n", y, palavra[y]);
        }
    } // fim repetir
    // mostrar o resultado de repeticoes de digitos
    IO_printf("\nNumero de digitos: %d\n", z);
...
int main()
{
    ...
    do
    {
        ...
        IO_println("Opcoes");
        IO_println(" 0 - parar");
        IO_println(" 1 - contar e mostrar todos os digitos, percorrendo do fim para o inicio de uma cadeia de caracteres");
        IO_println("");
