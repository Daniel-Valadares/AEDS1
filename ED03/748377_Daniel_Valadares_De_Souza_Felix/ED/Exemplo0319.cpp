...
// contar e mostrar uma quantidade de valores que posuem seus valores inteiro pares, e pertencam a um intervalo aberto
void method0319()
{
    // definir dado
    int x = 0;
    ...
    maior = IO_readdouble("\nInsira o maior valor real do intervalo aberto: ");
    while (maior < menor)
    {
    ...
    for (y = 0; y < qnt; y = y + 1)
    {
        ...
        if (menor < test && test < maior && !(convert % 2 == 0))
        {
            // contar repeticoes
            rpt = rpt + 1;
    ...
    IO_printf("\nNumero de valores dentro do intervalo, cujo a parte inteira e par: %d\n", rpt);
...
int main()
{
    ...
    do
    {
        ...
        IO_println("Opcoes");
        IO_println(" 0 - parar");
        IO_println(" 1 - contar e mostrar uma quantidade de valores que posuem seus valores inteiro pares, e pertencam a um intervalo aberto");
        IO_println("");
