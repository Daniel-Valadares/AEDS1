...
// contar e mostrar uma quantidade de valores que forem multiplos de 5 e nao multiplos de 3, e pertençam a um intervalo
void method0320()
{
    // definir dado
    int x = 0;
    ...
    qnt = IO_readdouble("Entrar com uma quantidade, real, de testes a serem feitos: ");
    IO_printf("\n");
    show = qnt;

    // ler valores do intervalo
    menor = IO_readdouble("Insira um valor entre 0 e 1 para ser o menor valor real do intervalo aberto: ");
    while (!(0 < menor && menor < 1))
    {
        IO_printf("ERRO: Valor conflitante inserido\n");
        menor = IO_readdouble("Insira o menor valor real do intervalo aberto: ");
    }
    maior = IO_readdouble("\nInsira um valor entre 0 e 1 para ser o maior valor real do intervalo aberto: ");
    while (maior < menor && !(0 < menor && menor < 1))
    {
        IO_printf("ERRO: Valor conflitante inserido\n");
        maior = IO_readdouble("\nInsira um valor entre 0 e 1 para ser o maior valor real do intervalo aberto: ");
    }
    ...
    {
        // ler valor de teste
        test = IO_readdouble("\nInsira um valor real a ser testado: \n");
        inteiro = (int)test;
        test2 = test - inteiro;
    ...
    IO_printf("\nNumero de valores que sua parte fracionada esta dentro do intervalo: %d\n", rpt);
...
int main()
{
    ...
    do
    {
        ...
        IO_println("Opcoes");
        IO_println(" 0 - parar");
        IO_println(" 1 - contar e mostrar uma quantidade de valores que posuem seus valores fracionados, e pertencam a um intervalo aberto");
        IO_println("");
...
Versao Data Modificacao
 ...
 0.18 __/__ alternativa
 0.19 __/__ outra alternativa
 0.20 __/__ outra alternativa
---------------------------------------------- testes
Versao Teste
 ...
 0.18 01. ( OK ) alternativa de teste de contagem de repeticoes em intervalo
 0.19 01. ( OK ) outra alternativa de teste de contagem de repeticoes em intervalo
 0.20 01. ( OK ) outra alternativa de teste de contagem de repeticoes em intervalo
*/
